...
class Task {
    ...
    setFunc(funcOnStart, funcOnEnd, funcOnPause, funcOnResume, funcOnStop, funcOnTick) {
    ...
    start() {
        if (this.taskState == TASK_STATE_READY || this.taskState == TASK_STATE_END || this.taskState == TASK_STATE_STOP) {
